        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastFourDigits = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    CardStatus = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationReference = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    EmploymentDuration = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ExistingLoans = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExistingCards = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MonthlyObligations = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    EstimatedExpenses = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    PrimaryBankAccountLast4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SelectedCardType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdentityDocName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AddressDocName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IncomeDocName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhotoDocName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OtherDocName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CurrentStage = table.Column<int>(type: "int", nullable: false),
                    IsRejected = table.Column<bool>(type: "bit", nullable: false),
                    RejectionReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubmittedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastStageUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditCardApplications_Cards_IssuedCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_MerchantProfiles_MerchantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FraudLogs_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_LastFourDigits",
                table: "Cards",
                column: "LastFourDigits");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditCardApplications_ApplicationReference",
                table: "CreditCardApplications",
                column: "ApplicationReference",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CreditCardApplications_CurrentStage",
                table: "CreditCardApplications",
                column: "CurrentStage");

            migrationBuilder.CreateIndex(
                name: "IX_CreditCardApplications_IssuedCardId",
                table: "CreditCardApplications",
                column: "IssuedCardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FraudLogs_IsResolved",
                table: "FraudLogs",
                column: "IsResolved");

            migrationBuilder.CreateIndex(
                name: "IX_FraudLogs_Severity",
                table: "FraudLogs",
                column: "Severity");

            migrationBuilder.CreateIndex(
                name: "IX_FraudLogs_TransactionId",
                table: "FraudLogs",
                column: "TransactionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MerchantProfiles_BusinessName",
